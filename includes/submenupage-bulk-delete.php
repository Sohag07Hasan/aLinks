<div class="wrap">
	...
	<form action="" method="post">
		...
		<table class="form-table">
			<tr>
				<td colspan="2"> Please select an operation. Before doing anything please make sure </td>
			</tr>
			...
			<tr>
				<td>
					...
					<input type="radio" id="alinks-delete" name="alinks-bulk-operation" value="4"> <label for="alinks-delete"> Delete (cannot undo) </label> <br/>
				</td>
			</tr>
